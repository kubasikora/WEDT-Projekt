...
\begin{figure}
    \begin{tikzpicture}
        ...
        \caption{Porównanie wyników odpowiadania, bazujących na dwóch różnych wyszukiwarkach internetowych}
\end{figure}
...
\begin{figure}
    \begin{tikzpicture}
		...
		\end{axis}
        \end{tikzpicture}
        \label{fig:duckduckgo-wynik}
        \caption{Szczegółowe wyniki odpowiadania przy użyciu wyszukiwarki \textit{DuckDuckGo}}
\end{figure}
...
\begin{figure}
    \begin{tikzpicture}
		...
		\end{axis}
        \end{tikzpicture}
        \label{fig:google-wyniki}
        \caption{Szczegółowe wyniki odpowiadania przy użyciu wyszukiwarki \textit{Google}}
\end{figure}
