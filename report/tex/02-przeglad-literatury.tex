...
Zasadniczo, system składa się z~czterech modułów. Pierwszy z~nich na podstawie pytania buduje zapytania do wyszukiwarki internetowej. Każde z~zapytań, zawiera pewną część oryginalnego pytania. Im więcej wyrazów oryginalnego zapytania znajduje się w~przygotowanym zapytaniu, tym z~większą wagą będą brane pod uwagę odpowiedzi na nie otrzymane.Po konstrukcji zapytań, są one wysyłane do wyszukiwarki internetowej. Do dalszych modułów wysyłane są jedynie krótkie fragmenty dokumentu, tzw. \emph{snippety}, przesyłane wraz z~linkami~\cite{brill2002analysis}.
...
\opracowanyartykul{Question Analysis for Polish Question Answering}
...
\opracowanyartykul{Learning Surface Text Patterns for a Question Answering System}
...
\opracowanyartykul{IBM's Statistical Question Answer System}
...
\opracowanyartykul{High Performance Question/Answering}
...
\opracowanyartykul{The structure and performance of Open-Domain QA System}
...
\opracowanyartykul{Aqualog: An ontology-portable question answering system for the semantic web}
