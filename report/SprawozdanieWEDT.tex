...
\newcommand{\opracowanyartykul}[1]{\textcolor{green}{\textbf{Artykuł:} #1\\}}
...
\label{sec:przeglad}
\input{tex/02-przeglad-literatury.tex}

\section{Projekt rozwiązania}
\label{sec:projekt-rozwiazania}
\input{tex/03-propozycja-rozwiazania.tex}

\section{Dane testowe}
\label{sec:dane-testowe}
\input{tex/04-dane.tex}

\section{Podsumowanie}
\label{sec:podsumowanie}
\input{tex/05-podsumowanie.tex}
